    ...
    SubShader
    {
        Tags
        {
         ...
         HLSLINCLUDE
            ...
            struct UCLAGL_GeomData
            {
                float4 positionCS         : SV_POSITION;
                float2 pos                : NDCPosition;
            ...
            [maxvertexcount(3)]
            void geom(triangle UCLAGL_GeomData input[3], inout TriangleStream<UCLAGL_GeomData> triStream)
            {

              float3 dist = UCLAGL_CalculateDistToCenter(input[0].pos, input[1].pos, input[2].pos);

              UCLAGL_GeomData vert0 = input[0];
              UCLAGL_GeomData vert1 = input[1];
              UCLAGL_GeomData vert2 = input[2];
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float4 _ScreenPosition_8fc3361a7c8443648bd66e294d0edb62_Out_0 = float4(IN.NDCPosition.xy, 0, 0);
            ...
            surface.Occlusion = 1;
            surface.Alpha = (_ScreenPosition_8fc3361a7c8443648bd66e294d0edb62_Out_0).x;
            return surface;
        }
